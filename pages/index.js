            ...
            <div className={[dmSans.className, ""].join(" ")}>
                ...
                <section id="hero" className="flex flex-col my-[64px] px-[24px] md:px-[264px] gap-[48px] items-center">
                    <div className="mb-8">
                        ...
                        <div className="text-center mt-4">
                            <Link href="/works/unulax-business" className="px-5 py-2 border border-black dark:border-white hover:bg-black dark:hover:bg-white hover:text-white dark:hover:text-black font-medium">Read more</Link>
                        </div>
                    </div>
                ...
                <section id="works_products" className="flex flex-col py-[48px] pb-[56px] px-[24px] md:px-[132px] gap-[32px] bg-black dark:bg-white text-white dark:text-black">
                    ...
                    <div className="flex justify-between">
                        <p className="text-lg font-medium">WORKS</p>
                    ...
                    <div className="flex flex-col md:flex-row gap-[40px] md:gap-[24px]">
                        <div className="w-full md:w-1/3">
                            <Image src="/homepage-hero_2.svg" alt="" width={568} height={408} />
                            <br />
                            <h2 className="font-medium text-2xl">Amobern – a sophisticated ecommerce app</h2>
                            <br />
                            <p className="text-gray-200 dark:text-gray-500">Ecommerce &nbsp;•&nbsp; Java, Spring, Elasticsearch, JavaScript, React (Next.js), etc.</p>
                            <br />
                            <div className="mt-3">
                                <Link href="#" className="px-5 py-2 border border-white dark:border-black hover:bg-white dark:hover:bg-black hover:text-black dark:hover:text-white font-medium">Read more</Link>
                            </div>
                        </div>
                        <div className="w-full md:w-1/3">
                            <Image src="/homepage-hero_2.svg" alt="" width={568} height={408} />
                            <br />
                            <h2 className="font-medium text-2xl">Amobern Pay – a modern payments solution</h2>
                            <br />
                            <p className="text-gray-200 dark:text-gray-500">FinTech &nbsp;•&nbsp; Java, Spring, JavaScript, React (Next.js), AWS, etc.</p>
                            <br />
                            <div className="mt-3">
                                <Link href="#" className="px-5 py-2 border border-white dark:border-black hover:bg-whitehover:bg-white dark:hover:bg-black hover:text-black dark:hover:text-white font-medium">Read more</Link>
                            </div>
                        </div>
                        <div className="w-full md:w-1/3">
                            <Image src="/homepage-hero_2.svg" alt="" width={568} height={408} />
                            <br />
                            <h2 className="font-medium text-2xl">Apostle Niyi Makinde – an interactive media app</h2>
                            <br />
                ...
                <section id="articles" className="flex flex-col py-[48px] pb-[56px] px-[24px] md:px-[132px] gap-[32px]">
                    ...
                    <div className="flex flex-col md:flex-row gap-[40px] md:gap-[24px]">
                        <div className="w-full md:w-1/4 flex flex-row md:flex-col gap-[16px]">
                            ...
                            <div className="flex flex-col gap-[16px] w-7/12 md:w-full">
                                <h2 className="font-medium text-2xl">How Computer Science is Changing the Field of Medicine</h2>
                                <p>This is an excerpt of the body of this article.</p>
                                <div className="mt-3">
                                    <Link href="#" className="px-5 py-2 border border-black dark:border-white hover:bg-black dark:hover:bg-white hover:text-white dark:hover:text-black font-medium">Read more</Link>
                                </div>
                            </div>
                        </div>
                        <div className="w-full md:w-1/4 flex flex-row md:flex-col gap-[16px]">
                            ...
                            <div className="flex flex-col gap-[16px] w-7/12 md:w-full">
                                <h2 className="font-medium text-2xl">Exploring the Intersection of Computer Science and Neuroscience</h2>
                                <p>This is an excerpt of the body of this article.</p>
                                <div className="mt-3">
                                    <Link href="#" className="px-5 py-2 border border-black dark:border-white hover:bg-black dark:hover:bg-white hover:text-white dark:hover:text-black font-medium">Read more</Link>
                                </div>
                        ...
                        <div className="w-full md:w-1/4 flex flex-row md:flex-col gap-[16px]">
                            ...
                            <div className="flex flex-col gap-[16px] w-7/12 md:w-full">
                                <h2 className="font-medium text-2xl">How to Implement and Optimize Reinforcement Learning Algorithms</h2>
                                <p>This is an excerpt of the body of this article.</p>
                                <div className="mt-3">
                                    <Link href="#" className="px-5 py-2 border border-black dark:border-white hover:bg-black dark:hover:bg-white hover:text-white dark:hover:text-black font-medium">Read more</Link>
                                </div>
                        ...
                        <div className="w-full md:w-1/4 flex flex-row md:flex-col gap-[16px]">
                            ...
                            <div className="flex flex-col gap-[16px] w-7/12 md:w-full">
                                <h2 className="font-medium text-2xl">How to Use Bayesian Networks for Probabilistic Reasoning</h2>
                                <p>This is an excerpt of the body of this article.</p>
                                <div className="mt-3">
                                    <Link href="#" className="px-5 py-2 border border-black dark:border-white hover:bg-black dark:hover:bg-white hover:text-white dark:hover:text-black font-medium">Read more</Link>
                                </div>
                    ...
                    <div className="flex flex-col md:flex-row gap-[40px] md:gap-[24px]">
                        <div className="w-full md:w-1/4 flex flex-row md:flex-col gap-[16px]">
                            ...
                            <div className="flex flex-col gap-[16px] w-7/12 md:w-full">
                                <h2 className="font-medium text-2xl">10 Algorithms Every Computer Scientist Should Know</h2>
                                <p>This is an excerpt of the body of this article.</p>
                                <div className="mt-3">
                                    <Link href="#" className="px-5 py-2 border border-black dark:border-white hover:bg-black dark:hover:bg-white hover:text-white dark:hover:text-black font-medium">Read more</Link>
                                </div>
                        ...
                        <div className="w-full md:w-1/4 flex flex-row md:flex-col gap-[16px]">
                            ...
                            <div className="flex flex-col gap-[16px] w-7/12 md:w-full">
                                <h2 className="font-medium text-2xl">The Impact of Computer Science on Education and Learning</h2>
                                <p>This is an excerpt of the body of this article.</p>
                                <div className="mt-3">
                                    <Link href="#" className="px-5 py-2 border border-black dark:border-white hover:bg-black dark:hover:bg-white hover:text-white dark:hover:text-black font-medium">Read more</Link>
                                </div>
                        ...
                        <div className="w-full md:w-1/4 flex flex-row md:flex-col gap-[16px]">
                            ...
                            <div className="flex flex-col gap-[16px] w-7/12 md:w-full">
                                <h2 className="font-medium text-2xl">The Ethics of Artificial Intelligence: Balancing Progress and Responsibility</h2>
                                <p>This is an excerpt of the body of this article.</p>
                                <div className="mt-3">
                                    <Link href="#" className="px-5 py-2 border border-black dark:border-white hover:bg-black dark:hover:bg-white hover:text-white dark:hover:text-black font-medium">Read more</Link>
                                </div>
                        ...
                        <div className="w-full md:w-1/4 flex flex-row md:flex-col gap-[16px]">
                            ...
                            <div className="flex flex-col gap-[16px] w-7/12 md:w-full">
                                <h2 className="font-medium text-2xl">How to Build and Train Convolutional Neural Networks for Computer Vision</h2>
                                <p>This is an excerpt of the body of this article.</p>
                                <div className="mt-3">
                                    <Link href="#" className="px-5 py-2 border border-black dark:border-white hover:bg-black dark:hover:bg-white hover:text-white dark:hover:text-black font-medium">Read more</Link>
                                </div>

...
export default function About() {
	return (
		<>
			<Head>
				<title>About – Kenny Otesile – Computer scientist and entrepreneur</title>
			</Head>
			...
			<div className={dmSans.className}>
				...
				<section id="about" className="py-[48px] px-[132px]">
					<article className="lg:w-[60%]">
						...
						<br />
						<p>
							Kenny Otesile is an entrepreneur, computer scientist and writer. He is the founder and CTO of{" "}
							<Link href="#" className="border-b-[1px] border-black hover:border-b-[2px]">
								Unulax
							</Link>
							{/* and Kenny Otesile, Inc */}; co-founder and CTO of{" "}
							<Link href="#" className="border-b-[1px] border-black hover:border-b-[2px]">
								Amobern Technologies
							</Link>
							; and CTO of{" "}
							<Link href="#" className="border-b-[1px] border-black hover:border-b-[2px]">
								Rebirth Global
							...
							{/* ; and president of Kenny Otesile Foundation */}.
						</p>
						<br />
						<p>
							Skilled in computer programming and software engineering, Kenny's work cuts across full-stack software engineering, artificial intelligence engineering, and software design and architecture. He is interested in the intersection of artificial intelligence with society, such as in finance technology, and human-computer interaction. His works and writings can be found at{" "}
							<Link href="/" className="border-b-[1px] border-black hover:border-b-[2px]">
								kennyotesile.com
							</Link>
							.
